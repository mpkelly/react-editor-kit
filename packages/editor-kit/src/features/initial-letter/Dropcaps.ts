...
(function () {
  ...
  var _fontMetricsCache: any = {};

  function getLineMetrics(css: any) {
  ...
  function createTestContainingBlock(document: any) {
  ...
  function newTestGlyph(container: any) {
  ...
  function destroyTestContainingBlock(element: any) {
    element.ownerDocument.body.removeChild(element);
  }

  function measureCapHeightRatio(
    testParent: any,
    fontFamily: any,
    width: any,
    height: any
    ...
    function _isBlack(imageData: any, pxIndex: any) {
    ...
    for (var y = 0; y < canvas.height; y++) {
      if (_isBlack(middleYline, y)) {
        ratio = ((bottomL as any) + 1 - y) / height;
        break;
      }
    }
  ...
  function getFontMetrics(document: any, fontFamily: any) {
  ...
  function toPxLength(pxNumber: any) {
    return pxNumber + "px";
  }

  function hasDescenderClass(dcapElement: any) {
  ...
  function isDescenderChar(dcapElement: any) {
  ...
  function resetDropcapStyle(element: any) {
    if (element.dcapjs) {
  ...
  function getCSSPropertyName(property: any) {
    var _supportElement = window.document.body
      ? window.document.body
      : document.createElement("div");
    function _supported(p: any) {
  ...
  global.Dropcap = {
    ...
    layout: function (dropcapRef: any, heightInLines: any, baselinePos: any) {
