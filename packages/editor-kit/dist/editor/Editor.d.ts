...
export declare const getActiveNode: (editor: ReactEditor) => import("slate").Text | import("slate").Element;
...
export declare const deleteBackward: (editor: ReactEditor, length: number, unit?: "line" | "character" | "word" | "block") => void;
...
export declare const getAncestor: (editor: ReactEditor, node: Node, level?: number) => import("slate").Text | import("slate").Element;
