...
export declare const isDeleting: (event: import("react").KeyboardEvent<Element> | KeyboardEvent) => boolean;
...
export declare const blockEvent: (event: import("react").KeyboardEvent<Element> | KeyboardEvent | MouseEvent | import("react").MouseEvent<any, MouseEvent>) => boolean;
